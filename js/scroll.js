...
// Content Setup
const texts = [
  ["Love","Love is the best thing in the world"],
  ["Wonderful","Capture the moment you want"],
  ["Interesting","Blur the background to focus your point"],
  ["Glowing","Glow your future like this phone"],
  ["Broken","Don't be the broken one"],
  ["HelloWorld", "It's Amazing. Future developer Java"]
];
